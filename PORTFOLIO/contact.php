...
if(isset($_POST["submitForm"])) {
  ...
  if($validForm) {
    $subject = "Johnston Library";
    $emailBody = "Thank you for reaching out to Johnston Library! \n\n We will be getting back to you shortly. \n\nThank You!!";
    $emailMessage = wordwrap($emailBody, 70);
    $fromEmail = "contactme@judebissoon.com";
...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="scss/contact/contact.css">
</head>
  <body>
