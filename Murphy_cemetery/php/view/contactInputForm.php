...
<html lang="en">
   ...
   <body>
    ...
    <div class="formContainer">
      <form action="../controller/processContactForm.php" method="POST">
        <!-- First Name Field -->
        <div>
        ...
        <div>
          ...
          <input type="text" id="contactLastName" name="contactLastName" placeholder="Smith" />
        </div>
        ...
        <div>
          ...
          <input type="text" id="contactCity" name="contactCity" placeholder="Story County" />
        </div>

        <!-- State Field -->
        <div>
          <label for="contactST">State:</label>
          <input type="text" id="contactST" name="contactST" placeholder="Iowa" />
        </div>

        <!-- Zip Code Field -->
        <div>
          <label for="contactZip">Zip Code:</label>
          <input type="text" id="contactZip" name="contactZip" placeholder="50201" />
        </div>
